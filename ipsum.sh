...
iptables -I INPUT -s 183.129.159.240/29 -j logdrop; iptables -I FORWARD -s 183.129.159.240/29 -j logdrop #(CN - Entire Range)
...
iptables -I INPUT -s 185.142.236.0/24 -j logdrop; iptables -I FORWARD -s 185.142.236.0/24 -j logdrop #(Netherlands - entire range)
iptables -I INPUT -s 80.82.77.0/24 -j logdrop; iptables -I FORWARD -s 80.82.77.0/24 -j logdrop #(Netherlands - entire range)
